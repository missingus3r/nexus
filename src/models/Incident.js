...
const incidentSchema = new mongoose.Schema({
  ...
  reporterUid: {
    type: String,
    required: false, // Not required for auto-generated incidents
    index: true,
    description: 'Auth0 UID of reporter (use "system" for auto-generated)'
  },
  reporterReputation: {
    type: Number,
    required: false, // Not required for auto-generated incidents
  ...
  autoGenerated: {
    type: Boolean,
    default: false,
    description: 'Whether this incident was auto-generated from news sources'
  },
  sourceNews: [{
    newsId: {
      type: mongoose.Schema.Types.ObjectId,
      ref: 'NewsEvent',
      description: 'Reference to news event that generated/supports this incident'
    },
    title: String,
    url: String,
    source: String,
  ...
  status: {
    type: String,
    enum: ['pending', 'verified', 'rejected', 'hidden', 'auto_verified'],
    default: 'pending',
    index: true,
    description: 'auto_verified = system-generated from news sources'
  },
  validationScore: {
    type: Number,
    default: 0,
...
incidentSchema.methods.toGeoJSON = function() {
  return {
    ...
    properties: {
      ...
      sourceNews: this.sourceNews.map(n => ({
        title: n.title,
        url: n.url,
        source: n.source,
        addedAt: n.addedAt
